...
import com.ridehub.user.service.ZaiChatbotService;
...
public class ChatbotResource {
    ...
    private final ZaiChatbotService zaiChatbotService;

    public ChatbotResource(ZaiChatbotService zaiChatbotService) {
