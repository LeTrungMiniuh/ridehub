...
/**
 * REST controller for managing {@link com.ridehub.route.domain.PricingTemplate}.
 */
@RestController
...
public class PricingTemplateResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new pricingTemplateDTO, or with status {@code 400 (Bad Request)} if the pricingTemplate has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("")
    public ResponseEntity<PricingTemplateDTO> createPricingTemplate(@Valid @RequestBody PricingTemplateDTO pricingTemplateDTO)
        throws URISyntaxException {
        LOG.debug("REST request to save PricingTemplate : {}", pricingTemplateDTO);
        if (pricingTemplateDTO.getId() != null) {
            throw new BadRequestAlertException("A new pricingTemplate cannot already have an ID", ENTITY_NAME, "idexists");
        }
        ...
        return ResponseEntity.created(new URI("/api/pricing-templates/" + pricingTemplateDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, pricingTemplateDTO.getId().toString()))
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated pricingTemplateDTO,
     * or with status {@code 400 (Bad Request)} if the pricingTemplateDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the pricingTemplateDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    public ResponseEntity<PricingTemplateDTO> updatePricingTemplate(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pricingTemplateDTO.getId().toString()))
            .body(pricingTemplateDTO);
    }

    /**
     * {@code PATCH  /pricing-templates/:id} : Partial updates given fields of an existing pricingTemplate, field will ignore if it is null
     *
     * @param id the id of the pricingTemplateDTO to save.
     * @param pricingTemplateDTO the pricingTemplateDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated pricingTemplateDTO,
     * or with status {@code 400 (Bad Request)} if the pricingTemplateDTO is not valid,
     * or with status {@code 404 (Not Found)} if the pricingTemplateDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the pricingTemplateDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<PricingTemplateDTO> partialUpdatePricingTemplate(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody PricingTemplateDTO pricingTemplateDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pricingTemplateDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of pricingTemplates in body.
     */
    @GetMapping("")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the pricingTemplateDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
